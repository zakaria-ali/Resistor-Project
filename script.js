...
function setColor(bandId, color) {
  ...
  if (bandId === "band1") {
    ...
    resistorValue.classList.add("visible");
    ...
    minValue.classList.add("visible");
    ...
    maxValue.classList.add("visible");
  }
}
...
function resetValues() {
  ...
  theNumber.innerHTML = "";
  theNumber.classList.remove("visible");

  multiplier.innerHTML = "";
  multiplier.classList.remove("visible");

  resistorValue.innerHTML = "";
  resistorValue.classList.remove("visible");

  minValue.innerHTML = "";
  minValue.classList.remove("visible");

  maxValue.innerHTML = "";
  maxValue.classList.add("visible");

  step1_1.innerHTML = "";
  step1_1.classList.remove("visible");

  step1_2.innerHTML = "";
  step1_2.classList.remove("visible");

  step2_1.innerHTML = "";
  step2_1.classList.remove("visible");

  step2_2.innerHTML = "";
  step2_2.classList.remove("visible");

  step3_1.innerHTML = "";
  step3_1.classList.remove("visible");

  step3_2.innerHTML = "";
  step3_2.classList.remove("visible");

  step3_3.innerHTML = "";
  step3_3.classList.remove("visible");

  step4_1.innerHTML = "";
  step4_1.classList.remove("visible");

  step4_2.innerHTML = "";
  step4_2.classList.remove("visible");

  step4_3.innerHTML = "";
  step4_3.classList.remove("visible");
